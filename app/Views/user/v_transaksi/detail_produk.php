		...
		<div class="row s_product_inner">
					...
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" src="<?=site_url()?>assets/file_upload/produk/<?=$row['gambar']?>"
									alt="First slide">
							</div>
						</div>
					</div>
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					...
					<div class="card_area">
						<a class="main_btn" href="https://wa.me/6283831936745?text=Hay kak saya mau beli!" target="none">Beli Sekarang</a>
					</div>
				</div>
			</div>
		</div>
